...
@Operation(
        summary = "좌석 등급 좌석 목록 조회",
        description = """
        **특정 좌석 등급의 모든 좌석을 조회**
        
        **처리 과정:**
        1. 좌석 등급 ID로 해당 등급의 모든 좌석 정보 조회
        2. 좌석 목록 반환
                        ...
                        examples = {
                                @ExampleObject(
                                        ...
                                        value = """
                                        {
                                            ...
                                            "path": "/api/v1/seat-grades/999/seats"
                                        }
                                        """
                                )
                        }
                        ...
                        examples = {
                                @ExampleObject(
                                        ...
                                        value = """
                                        {
                                            ...
                                            "message": "인증이 필요합니다.",
                                            "path": "/api/v1/seat-grades/1/seats"
                                        }
                                        """
                                )
                        }
...
public @interface GetSeatsBySeatGradeIdApiDoc {
}