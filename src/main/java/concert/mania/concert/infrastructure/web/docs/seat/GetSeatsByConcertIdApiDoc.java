...
@Operation(
        ...
        **처리 과정:**
        1. 콘서트 ID로 해당 콘서트의 모든 좌석 정보 조회
        2. 선택적으로 좌석 등급 ID 또는 상태로 필터링 가능
        3. 좌석 목록 반환
        
        **파라미터:**
        - concertId: 콘서트 ID (필수)
        - seatGradeId: 좌석 등급 ID (선택)
        - status: 좌석 상태 (선택)
                        ...
                        examples = {
                                @ExampleObject(
                                        ...
                                        value = """
                                        {
                                            ...
                                            "path": "/api/v1/concerts/999/seats"
                                        }
                                        """
                                )
                        }
...
public @interface GetSeatsByConcertIdApiDoc {
}